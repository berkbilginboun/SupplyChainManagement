...
# Function to solve profit maximization for a firm
...
# Question 6: Q&H promotes in April, Unilock does not promote
qh_demand, unilock_demand = adjust_demand(qh_promo=4, unilock_promo=None)
